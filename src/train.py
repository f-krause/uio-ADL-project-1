...
def save_data(model_name, model, losses):
    ...
    save_path_model = f"../experiments/{model_name}_model.pt"  # TODO change back to output!
    save_path_csv = f"../experiments/losses_{model_name}_model.csv"  # TODO change back to output!
